...
<Configuration monitorInterval="5">
    ...
    <Appenders>
        ...
        <Rewrite name="SanitizePATTokens">
            <AppenderRef ref="SanitizePasswords"/>
            <PATTokenRewritePolicy/>
        </Rewrite>
    </Appenders>
    <Loggers>
        ...
        <AsyncLogger name="de.triology.cas.pat" level="${sys:ces.log.level}" includeLocation="true" additivity="false">
            <AppenderRef ref="SanitizePATTokens"/>
        </AsyncLogger>
        <AsyncLogger name="org.springframework.web.servlet.mvc.method.annotation.RequestResponseBodyMethodProcessor" level="off" includeLocation="true" additivity="false"/>
