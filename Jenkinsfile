...
pipe.overrideStage('Integration Tests') {
        ...
        ecoSystem.ssh "sudo kubectl cp /dogu/integrationTests/services/ cas:/etc/cas/services/production/"
        ecoSystem.sshOut "sudo kubectl exec cas ls /etc/cas/services/production"
