...
public class CesOAuth20ClientIdClientSecretAuthenticator implements Authenticator<UsernamePasswordCredentials> {
    ...
    protected void validateCredentials(final UsernamePasswordCredentials credentials,
        ...
        if (!checkClientSecret(registeredService, credentials.getPassword(), registeredServiceCipherExecutor)) {
