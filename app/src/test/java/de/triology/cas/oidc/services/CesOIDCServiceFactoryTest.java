...
public class CesOIDCServiceFactoryTest extends TestCase {
    ...
    public void testCreateNewService_noAttributes() {
        ...
        try {
            ...
            // then
            assertNotNull(e);
            assertEquals("Cannot create OIDC client service; Cannot find attributes", e.getMessage());
        }
    }
    ...
    public void testCreateNewService_noClientID() {
        ...
        try {
            ...
            // then
            assertNotNull(e);
            assertEquals("Cannot create OIDC client service; Cannot find attribute: oidc_client_id", e.getMessage());
        }
    }
    ...
    public void testCreateNewService_noClientSecret() {
        ...
        CesOIDCServiceFactory factory = new CesOIDCServiceFactory();
        Map<String, String> attributes = new HashMap<>();
        attributes.put(CesOIDCServiceFactory.ATTRIBUTE_KEY_OIDC_CLIENT_ID, "superID");
        CesServiceData serviceData = new CesServiceData("oidcClient", factory, attributes);
        ...
        try {
            ...
            // then
            assertNotNull(e);
            assertEquals("Cannot create OIDC client service; Cannot find attribute: oidc_client_secret", e.getMessage());
        }
    }
    ...
    public void testCreateNewService_emptyLogoutURI() throws CesServiceCreationException {
        ...
        Map<String, String> attributes = new HashMap<>();
        attributes.put(CesOIDCServiceFactory.ATTRIBUTE_KEY_OIDC_CLIENT_ID, "superID");
        attributes.put(CesOIDCServiceFactory.ATTRIBUTE_KEY_OIDC_CLIENT_SECRET_HASH, "superSecretHash");
        CesServiceData serviceData = new CesServiceData("oidcClient", factory, attributes);
