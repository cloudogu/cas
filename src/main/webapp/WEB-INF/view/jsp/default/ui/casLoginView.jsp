		...
		<div id="content">
			<div id="container-main">
				<div id="container-main-middle">
					...
					<div id="login" class="box-flpanel">
			...
			<!--<h2><spring:message code="screen.welcome.instructions" /></h2>-->
						...
						<div class="row fl-controls-left">
							...
							<form:input cssClass="required" cssErrorClass="error" id="username" placeholder="Username" size="25" tabindex="1" accesskey="${userNameAccessKey}" path="username" autocomplete="false" htmlEscape="true" />
							</c:if>
						</div>
						<div class="row fl-controls-left">
							...
							<form:password cssClass="required" cssErrorClass="error" id="password" placeholder= "Password" size="25" tabindex="2" path="password"  accesskey="${passwordAccessKey}" htmlEscape="true" autocomplete="off" />
						</div>
						<!--<div class="row check">
